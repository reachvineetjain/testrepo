...
/**
 * <p>Java class for BirthCntryCodeType.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="BirthCntryCodeType">
 ...
 * 
 */
@XmlType(name = "BirthCntryCodeType", namespace = "http://www.ice.gov/xmlschema/sevisbatch/alpha/Table")
@XmlEnum
public enum BirthCntryCodeType {
    ...
    public static BirthCntryCodeType fromValue(String v) {
        for (BirthCntryCodeType c: BirthCntryCodeType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
