...
/**
 * <p>Java class for CntryCodeWithCloseDateType.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="CntryCodeWithCloseDateType">
 ...
 * 
 */
@XmlType(name = "CntryCodeWithCloseDateType", namespace = "http://www.ice.gov/xmlschema/sevisbatch/alpha/Table")
@XmlEnum
public enum CntryCodeWithCloseDateType {
    ...
    CntryCodeWithCloseDateType(String v) {
        value = v;
    }
    ...
    public static CntryCodeWithCloseDateType fromValue(String v) {
        for (CntryCodeWithCloseDateType c: CntryCodeWithCloseDateType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
