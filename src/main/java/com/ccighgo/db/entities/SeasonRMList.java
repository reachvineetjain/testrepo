...
/**
 * The persistent class for the SeasonRMList database table.
 * 
 */
@Entity
@NamedQuery(name="SeasonRMList.findAll", query="SELECT s FROM SeasonRMList s")
public class SeasonRMList implements Serializable {
