...
/**
 * The persistent class for the SeasonRDList database table.
 * 
 */
@Entity
@NamedQuery(name="SeasonRDList.findAll", query="SELECT s FROM SeasonRDList s")
public class SeasonRDList implements Serializable {
