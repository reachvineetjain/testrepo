...
/**
 * The persistent class for the AnnouncementInformationHistory database table.
 * 
 */
@Entity
@Table(name="AnnouncementInformationHistory")
@NamedQuery(name="AnnouncementInformationHistory.findAll", query="SELECT a FROM AnnouncementInformationHistory a")
public class AnnouncementInformationHistory implements Serializable {
