...
/**
 * The persistent class for the SeasonERDList database table.
 * 
 */
@Entity
@NamedQuery(name="SeasonERDList.findAll", query="SELECT s FROM SeasonERDList s")
public class SeasonERDList implements Serializable {
