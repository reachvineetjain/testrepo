...
public class SevisBatch {
   ...
   // when we submit batch file they will return log file --> this is for
   // processing !
   ...
   public Response updateReprint(BatchParam batchParam) {
      ...
      // servletContext);
      UpdateStudentDependentReprintBatchDataService dataService = getServiceBean(UpdateStudentDependentReprintBatchDataService.class);
      return stuBatchGenerator.createBatch(batchParam, dataService, servletContext);
   }
   ...
   public Response updateProgramExtension(BatchParam batchParam) {
      ...
      // return evBatchGenerator.createBatch(batchParam, dataService,
      // servletContext);

      // Student
      UpdateStudentProgramExtentionBatchDataService dataService = getServiceBean(UpdateStudentProgramExtentionBatchDataService.class);
      return stuBatchGenerator.createBatch(batchParam, dataService, servletContext);
   }
   ...
   public Response updateProgramShorten(BatchParam batchParam) {
      ...
      // Student
      // UpdateStudentProgramShortenBatchDataService dataService =
      // getServiceBean(
      // UpdateStudentProgramShortenBatchDataService.class);
      // return stuBatchGenerator.createBatch(batchParam, dataService,
      // servletContext);
