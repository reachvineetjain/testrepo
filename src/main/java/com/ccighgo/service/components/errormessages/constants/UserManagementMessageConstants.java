...
public class UserManagementMessageConstants {

   public static final String INVALID_USER_ID = "invalid.user.id";
   public static final String USR_MGMT_GET_ERROR = "error.get.user";
   public static final String FAILED_GET_ALL_USERS = "error.get.all.user";
   public static final String USR_MGMT_CREATE_USER_FAILED = "error.create.user";
   ...
   public static final String USR_MGMT_UPDATE_USER_PARAM_REQUIRED = "error.update.user.param.required";
   public static final String USR_MGMT_UPDATE_USER_FAILED = "error.update.user";
   public static final String USR_MGMT_UPDATE_USER_PERMISSIONS_FAILED = "error.update.user.permissions";
   public static final String FAILED_UPDATE_USER_PICTURE = "error.update.user.picture";
   public static final String USR_MGMT_SEARCH_USER_ERROR = "error.search.user";
   ...
   public static final String INVALID_PAGE_NUM_OR_SIZE = "invalid.pageno.or.size";
   public static final String FAILED_USER_NULL = "error.add.user.null";
   public static final String FAILED_GET_USER_LIST = "error.get.user.list";
   public static final String FAILED_USER_DETAILS_CREATION = "error.user.details.creation";
   public static final String FAILED_USER_DEPT_PROGRAM_CREATION = "error.user.dept.program.creation";
   ...
   public static final String USR_MGMT_UPDATE_USER_EMAIL_EXIST = "error.update.user.email.exist";
   public static final String USR_MGMT_UPDATE_USER_NAME_EXIST = "error.update.user.name.exist";
   public static final String FAILED_GET_ROLE_BY_DEPARTMENT = "error.get.role.by.department";
   public static final String FAILED_GET_ALL_SUPERVISORS = "error.get.all.supervisors";
}
