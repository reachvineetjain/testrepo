...
public class RegionManagementMessageConstants {
   ...
   public static final String SUP_REG_NAME_DUPLICATE_SAME_SEASON = "error.add.super.region.name.already.exists.same.season";
   ...
   public static final String REG_NAME_DUP_SAME_SEASON ="error.add.region.name.already.exists.same.season";
