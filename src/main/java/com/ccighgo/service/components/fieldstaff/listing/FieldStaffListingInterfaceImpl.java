		...
		try {
			...
			if (result != null) {
				...
				for (Object[] obj : result) {
					/*
					 * 1 fieldStaffGold 2 fsGoldphoto 3 fsFirstName 4 fsLastName
					 * 5 phone 6 city 7 zipCode 8 stateName 9 active 10 email II
					 * seasonName 12 seasonStatus 13 fsHierarchyGoId 14
					 * fsHierarchyGoldphoto 15 fieldStaffType 16
					 * fsHierarchyFirstName 17 fsHierarchyLastName
					 */
		...
		try {
			...
			if (result != null) {
				...
				for (Object[] obj : result) {
					/*
					 * 1 fieldStaffGold 2 fsGoldphoto 3 fsFirstName 4 fsLastName
					 * 5 phone 6 city 7 zipCode 8 stateName 9 active 10 email 11
