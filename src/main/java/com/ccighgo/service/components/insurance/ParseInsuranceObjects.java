...
public class ParseInsuranceObjects {
   ...
   private InsurancePlans planUnMarshalle(String planAsJson) throws JAXBException {
      Gson gson = new Gson();
      return gson.fromJson(planAsJson, InsurancePlans.class);
   }

   public static void main(String[] args) throws JAXBException {
      ParseInsuranceObjects p = new ParseInsuranceObjects();
      InsurancePlans result = p.planUnMarshalle(
