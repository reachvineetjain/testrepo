...
public class SeasonServiceInterfaceImpl implements SeasonServiceInterface {
		...
		try {
			...
			if (allseasons != null && !(allseasons.isEmpty())) {
				...
				for (int i = 0; i < allseasons.size(); i++) {
					...
					seasonServiceImplUtil
							.convertEntitySeasonToSeasonListObject(seasonBean,
									seasonEntity);
	...
	public SeasonBean createSeason(SeasonBean seasonBean) {
		try {
			...
			seasonServiceImplUtil.convertSeasonBeanToSeasonEntity(seasonBean,
					seasonEntity, false);
			seasonEntity = seasonRepository.saveAndFlush(seasonEntity);
			seasonServiceImplUtil.createSeasonHspConfiguration(seasonBean,
					seasonEntity);
			seasonServiceImplUtil
					.createSeasonPrograms(seasonEntity, seasonBean);
			return viewSeason(seasonEntity.getSeasonId()
					+ CCIConstants.EMPTY_DATA);
		} catch (Exception e) {
			ExceptionUtil.logException(e, LOGGER);
		}
		return null;
	...
	public SeasonBean viewSeason(String id) {
		...
		try {
			Season seasonEntity = seasonRepository
					.findOne(Integer.parseInt(id));
			if (seasonEntity != null) {
				SeasonBean seasonBean = new SeasonBean();
				seasonServiceImplUtil.convertEntitySeasonToBeanSeason(
						seasonBean, seasonEntity);
				return seasonBean;
			}
		} catch (Exception e) {
			ExceptionUtil.logException(e, LOGGER);
	...
	public SeasonBean updateSeason(SeasonBean seasonBean) {
		try {
			...
			seasonServiceImplUtil.convertSeasonBeanToSeasonEntity(seasonBean,
					seasonEntity, true);
			seasonRepository.saveAndFlush(seasonEntity);
			seasonServiceImplUtil.updateSeasonHspConfiguration(seasonBean,
					seasonEntity);
			return viewSeason(seasonEntity.getSeasonId()
					+ CCIConstants.EMPTY_DATA);
		} catch (Exception e) {
	...
	public SeasonPrograms getSeasonPrograms(String seasonId) {
		...
		try {
			...
			if (season != null) {
				...
				List<DepartmentProgram> departmentPrograms = dept
				...
				for (DepartmentProgram dPrg : departmentPrograms) {
					...
					if (dPrg.getProgramName().equals(CCIConstants.HSP_J1_HS)) {
						...
						sprg.setProgramName(season.getSeasonName()
								+ CCIConstants.HYPHEN_SPACE
								+ dPrg.getProgramName());
					...
					if (dPrg.getProgramName().equals(
							CCIConstants.GHT_TEACH_ABRD)) {
						sprg.setSeasonId(Integer.valueOf(seasonId));
						sprg.setProgramName(season.getSeasonName()
								+ CCIConstants.HYPHEN_SPACE
								+ dPrg.getProgramName());
	...
	public SeasonHspJ1HSDetails getHSPJ1HSSeasonDetails(String seasonId) {
		...
		try {
			SeasonJ1Detail seasonJ1Detail = seasonJ1DetailsRepository
					.findJ1DetailsBySeasonId(Integer.valueOf(seasonId));
			if (seasonJ1Detail != null) {
				seasonHspJ1HSDetails = new SeasonHspJ1HSDetails();
				seasonHspJ1HSDetails.setSeasonId(seasonJ1Detail.getSeason()
						.getSeasonId());
				seasonHspJ1HSDetails.setJ1HsBasicDetail(seasonServiceImplUtil
						.getJ1HSBasicDetail(seasonJ1Detail));
				seasonHspJ1HSDetails.setJ1HsJanStart(seasonServiceImplUtil
						.getJ1HSJanStart(seasonJ1Detail));
				seasonHspJ1HSDetails.setJ1HsAugStart(seasonServiceImplUtil
						.getJ1HSAugStart(seasonJ1Detail));
				seasonHspJ1HSDetails.setJ1HsFieldSettings(seasonServiceImplUtil
						.getJ1HSFieldSettings(seasonJ1Detail));
	...
	public J1HSBasicDetail getHSPJ1HSSeasonNameAndStatus(String seasonId) {
		...
		try {
			SeasonJ1Detail seasonJ1Detail = seasonJ1DetailsRepository
					.findJ1DetailsBySeasonId(Integer.valueOf(seasonId));
			if (seasonJ1Detail != null) {
				j1hsBasicDetail = seasonServiceImplUtil
						.getJ1HSBasicDetail(seasonJ1Detail);
			}
		} catch (CcighgoException e) {
			ExceptionUtil.logException(e, LOGGER);
	...
	public J1HSJanStart getHSPJ1HSSeasonJanStartDetails(String seasonId) {
		...
		try {
			SeasonJ1Detail seasonJ1Detail = seasonJ1DetailsRepository
					.findJ1DetailsBySeasonId(Integer.valueOf(seasonId));
			if (seasonJ1Detail != null) {
				j1hsJanStart = seasonServiceImplUtil
						.getJ1HSJanStart(seasonJ1Detail);
			}
		} catch (CcighgoException e) {
			ExceptionUtil.logException(e, LOGGER);
	...
	public J1HSAugStart getHSPJ1HSSeasonAugStartDetails(String seasonId) {
		...
		try {
			SeasonJ1Detail seasonJ1Detail = seasonJ1DetailsRepository
					.findJ1DetailsBySeasonId(Integer.valueOf(seasonId));
			if (seasonJ1Detail != null) {
				j1hsAugStart = seasonServiceImplUtil
						.getJ1HSAugStart(seasonJ1Detail);
			}
		} catch (CcighgoException e) {
			ExceptionUtil.logException(e, LOGGER);
	...
	public J1HSFieldSettings getHSPJ1HSSeasonFieldSettings(String seasonId) {
		...
		try {
			SeasonJ1Detail seasonJ1Detail = seasonJ1DetailsRepository
					.findJ1DetailsBySeasonId(Integer.valueOf(seasonId));
			if (seasonJ1Detail != null) {
				j1hsFieldSettings = seasonServiceImplUtil
						.getJ1HSFieldSettings(seasonJ1Detail);
			}
		} catch (CcighgoException e) {
			ExceptionUtil.logException(e, LOGGER);
	...
	public J1HSProgramAllocations getHSPJ1HSSeasonProgramAllocation(
			String seasonId) {
	...
	@Override
	public SeasonHspJ1HSDetails updateHSPJ1HSSeasonDetails(
			SeasonHspJ1HSDetails seasonHspJ1HSDetails) {
		...
		try {
			SeasonJ1Detail seasonJ1Detail = seasonJ1DetailsRepository
					.findJ1DetailsBySeasonId(Integer
							.valueOf(seasonHspJ1HSDetails.getSeasonId()));
			if (seasonJ1Detail != null) {
				if (seasonHspJ1HSDetails.getJ1HsBasicDetail() != null) {
					seasonServiceImplUtil.updateJ1BasicDetails(
							seasonHspJ1HSDetails.getJ1HsBasicDetail(),
							seasonJ1Detail);
				}
				if (seasonHspJ1HSDetails.getJ1HsJanStart() != null) {
					seasonServiceImplUtil.updateJ1JanStartDetails(
							seasonHspJ1HSDetails.getJ1HsJanStart(),
							seasonJ1Detail);
				}
				if (seasonHspJ1HSDetails.getJ1HsAugStart() != null) {
					seasonServiceImplUtil.updateJ1AugStartDetails(
							seasonHspJ1HSDetails.getJ1HsAugStart(),
							seasonJ1Detail);
				}
				if (seasonHspJ1HSDetails.getJ1HsFieldSettings() != null) {
					seasonServiceImplUtil.updateJ1FSSettings(
							seasonHspJ1HSDetails.getJ1HsFieldSettings(),
							seasonJ1Detail);
				}
				seasonJ1Detail = seasonJ1DetailsRepository
						.saveAndFlush(seasonJ1Detail);
	...
	@Override
	public J1HSBasicDetail updateHSPJ1HSSeasonNameAndStatus(
		...
		try {
			SeasonJ1Detail seasonJ1Detail = seasonJ1DetailsRepository
					.findJ1DetailsBySeasonId(Integer.valueOf(j1hsBasicDetail
							.getSeasonId()));
			if (seasonJ1Detail != null) {
				seasonServiceImplUtil.updateJ1BasicDetails(j1hsBasicDetail,
						seasonJ1Detail);
				seasonJ1Detail = seasonJ1DetailsRepository
						.saveAndFlush(seasonJ1Detail);
	...
	@Override
	public J1HSJanStart updateHSPJ1HSSeasonJanStartDetails(
		...
		try {
			SeasonJ1Detail seasonJ1Detail = seasonJ1DetailsRepository
					.findJ1DetailsBySeasonId(Integer.valueOf(j1hsJanStart
							.getSeasonId()));
			if (seasonJ1Detail != null) {
				seasonServiceImplUtil.updateJ1JanStartDetails(j1hsJanStart,
						seasonJ1Detail);
				seasonJ1Detail = seasonJ1DetailsRepository
						.saveAndFlush(seasonJ1Detail);
	...
	@Override
	public J1HSAugStart updateHSPJ1HSSeasonAugStartDetails(
		...
		try {
			SeasonJ1Detail seasonJ1Detail = seasonJ1DetailsRepository
					.findJ1DetailsBySeasonId(Integer.valueOf(j1hsAugStart
							.getSeasonId()));
			if (seasonJ1Detail != null) {
				seasonServiceImplUtil.updateJ1AugStartDetails(j1hsAugStart,
						seasonJ1Detail);
				seasonJ1Detail = seasonJ1DetailsRepository
						.saveAndFlush(seasonJ1Detail);
	...
	@Override
	public J1HSFieldSettings updateHSPJ1HSSeasonFieldSettings(
		...
		try {
			SeasonJ1Detail seasonJ1Detail = seasonJ1DetailsRepository
					.findJ1DetailsBySeasonId(Integer.valueOf(j1hsFieldSettings
							.getSeasonId()));
			if (seasonJ1Detail != null) {
				seasonServiceImplUtil.updateJ1FSSettings(j1hsFieldSettings,
						seasonJ1Detail);
				seasonJ1Detail = seasonJ1DetailsRepository
						.saveAndFlush(seasonJ1Detail);
	...
	@Override
	public J1HSProgramAllocations updateHSPJ1HSSeasonProgramAllocation(
			J1HSProgramAllocations j1hsProgramAllocations) {
		return null;
	}

	public HSPF1ProgramAllocations getHSPF1ProgramAllocations(String seasonId) {
		try {
			SeasonF1Detail allF1Details = seasonF1DetailsRepository
					.getAllSeasonF1DetailById(Integer.valueOf(seasonId));
			return seasonServiceImplUtil.getHSPF1ProgramAllocations(
					allF1Details, seasonId);
		} catch (CcighgoException e) {
			ExceptionUtil.logException(e, LOGGER);
		}
		return null;
	...
	public HSPF1AugustStart1StSemesterDetails getHSPF1AugustStart1StSemesterDetails(
		...
		try {
			SeasonF1Detail allF1Details = seasonF1DetailsRepository
					.getAllSeasonF1DetailById(Integer.valueOf(seasonId));
			return seasonServiceImplUtil.getHSPF1AugustStart1StSemesterDetails(
					allF1Details, seasonId);
		} catch (CcighgoException e) {
			ExceptionUtil.logException(e, LOGGER);
		}
	...
	public HSPF1AugustStartFullYearDetails getHSPF1AugustStartFullYearDetails(
		...
		try {
			SeasonF1Detail allF1Details = seasonF1DetailsRepository
					.getAllSeasonF1DetailById(Integer.valueOf(seasonId));
			return seasonServiceImplUtil.getHSPF1AugustStartFullYearDetails(
					allF1Details, seasonId);
		} catch (CcighgoException e) {
			ExceptionUtil.logException(e, LOGGER);
		}
	...
	public HSPF1JanuaryStart2NdSemesterDetails getHSPF1JanuaryStart2NdSemesterDetails(
		...
		try {
			SeasonF1Detail allF1Details = seasonF1DetailsRepository
					.getAllSeasonF1DetailById(Integer.valueOf(seasonId));
			return seasonServiceImplUtil
					.getHSPF1JanuaryStart2NdSemesterDetails(allF1Details,
							seasonId);
		} catch (CcighgoException e) {
			ExceptionUtil.logException(e, LOGGER);
		}
	...
	public HSPF1JanuaryStartFullYearDetail getHSPF1JanuaryStartFullYearDetails(
		...
		try {
			SeasonF1Detail allF1Details = seasonF1DetailsRepository
					.getAllSeasonF1DetailById(Integer.valueOf(seasonId));
			return seasonServiceImplUtil.getHSPF1JanuaryStartFullYearDetails(
					allF1Details, seasonId);
		} catch (CcighgoException e) {
			ExceptionUtil.logException(e, LOGGER);
		}
	...
	public SeasonHSPF1Details getSeasonHSPF1Details(String seasonId) {
		try {
			...
			SeasonF1Detail allF1Details = seasonF1DetailsRepository
					.getAllSeasonF1DetailById(Integer.valueOf(seasonId));
			seasonHSPF1Details.setDetails(seasonServiceImplUtil
					.getHSPF1NameAndStatus(allF1Details, seasonId));
			seasonHSPF1Details
					.setJanuaryStart2NdSemesterDetails(seasonServiceImplUtil
							.getHSPF1JanuaryStart2NdSemesterDetails(
									allF1Details, seasonId));
			seasonHSPF1Details
					.setJanuaryStartFullYearDetail(seasonServiceImplUtil
							.getHSPF1JanuaryStartFullYearDetails(allF1Details,
									seasonId));
			seasonHSPF1Details
					.setAugustStart1StSemesterDetails(seasonServiceImplUtil
							.getHSPF1AugustStart1StSemesterDetails(
									allF1Details, seasonId));
			seasonHSPF1Details
					.setAugustStartFullYearDetails(seasonServiceImplUtil
							.getHSPF1AugustStartFullYearDetails(allF1Details,
									seasonId));
			seasonHSPF1Details.setAccounting(seasonServiceImplUtil
					.getHSPF1Accounting(allF1Details, seasonId));
			seasonHSPF1Details.setFieldSettings(seasonServiceImplUtil
					.getHSPF1FieldSettings(allF1Details, seasonId));
			seasonHSPF1Details.setProgramAllocations(seasonServiceImplUtil
					.getHSPF1ProgramAllocations(allF1Details, seasonId));
	...
	public SeasonHSPF1Details updateF1Details(
			SeasonHSPF1Details seasonHSPF1Details) {
		try {
			SeasonF1Detail allF1Details = seasonF1DetailsRepository
					.getAllSeasonF1DetailById(seasonHSPF1Details.getSeasonId());
			if (allF1Details != null) {
				SeasonHSPF1Details updatedSeasonHSPF1Details = seasonServiceImplUtil
						.updateF1Details(allF1Details, seasonHSPF1Details);
				seasonHSPF1Details = seasonServiceImplUtil.updateF1Details(
						allF1Details, seasonHSPF1Details);
			}
	...
	public HSPF1BasicDetails updateHSPF1NameAndStatus(
		...
		try {
			SeasonF1Detail allF1Details = seasonF1DetailsRepository
					.getAllSeasonF1DetailById(hspf1BasicDetails.getSeasonId());
			if (allF1Details != null) {
				hspf1BasicDetails = seasonServiceImplUtil
						.updateHSPF1NameAndStatus(allF1Details,
								hspf1BasicDetails);
			}
	...
	public HSPF1Accounting updateF1Accounting(HSPF1Accounting hspf1Accounting) {
		try {
			SeasonF1Detail allF1Details = seasonF1DetailsRepository
					.getAllSeasonF1DetailById(hspf1Accounting.getSeasonId());
			if (allF1Details != null) {
				hspf1Accounting = seasonServiceImplUtil.updateF1Accounting(
						allF1Details, hspf1Accounting);
			}
	...
	public HSPF1JanuaryStart2NdSemesterDetails updateF1JanStart2NdSemesterDetails(
		...
		try {
			SeasonF1Detail allF1Details = seasonF1DetailsRepository
					.getAllSeasonF1DetailById(hspf1JanuaryStart2NdSemesterDetails
							.getSeasonId());
			if (allF1Details != null) {
				hspf1JanuaryStart2NdSemesterDetails = seasonServiceImplUtil
						.updateF1JanStart2NdSemesterDetails(allF1Details,
								hspf1JanuaryStart2NdSemesterDetails);
			}
	...
	public HSPF1JanuaryStartFullYearDetail updateF1JanStartFullYearDetails(
		...
		try {
			SeasonF1Detail allF1Details = seasonF1DetailsRepository
					.getAllSeasonF1DetailById(hspf1JanuaryStartFullYearDetail
							.getSeasonId());
			if (allF1Details != null) {
				hspf1JanuaryStartFullYearDetail = seasonServiceImplUtil
						.updateF1JanStartFullYearDetails(allF1Details,
								hspf1JanuaryStartFullYearDetail);
			}
	...
	public HSPF1AugustStart1StSemesterDetails updateF1AugStart1StSemesterDetails(
		...
		try {
			SeasonF1Detail allF1Details = seasonF1DetailsRepository
					.getAllSeasonF1DetailById(hspf1AugustStart1StSemesterDetails
							.getSeasonId());
			if (allF1Details != null) {
				hspf1AugustStart1StSemesterDetails = seasonServiceImplUtil
						.updateF1AugStart1StSemesterDetails(allF1Details,
								hspf1AugustStart1StSemesterDetails);
			}
	...
	public HSPF1AugustStartFullYearDetails updateF1AugStartFullYearDetails(
		...
		try {
			SeasonF1Detail allF1Details = seasonF1DetailsRepository
					.getAllSeasonF1DetailById(hspf1AugustStartFullYearDetails
							.getSeasonId());
			if (allF1Details != null) {
				hspf1AugustStartFullYearDetails = seasonServiceImplUtil
						.updateF1AugStartFullYearDetails(allF1Details,
								hspf1AugustStartFullYearDetails);
			}
	...
	public HSPF1FieldSettings updateF1FieldSettings(
		...
		try {
			SeasonF1Detail allF1Details = seasonF1DetailsRepository
					.getAllSeasonF1DetailById(hspf1FieldSettings.getSeasonId());
			if (allF1Details != null) {
				hspf1FieldSettings = seasonServiceImplUtil
						.updateF1FieldSettings(allF1Details, hspf1FieldSettings);
			}
	...
	public HSPF1ProgramAllocations updateF1ProgramAllocation(
		...
		try {
			SeasonF1Detail allF1Details = seasonF1DetailsRepository
					.getAllSeasonF1DetailById(hspf1ProgramAllocations
							.getSeasonId());
			if (allF1Details != null) {
				hspf1ProgramAllocations = seasonServiceImplUtil
						.updateF1ProgramAllocation(allF1Details,
								hspf1ProgramAllocations);
			}
	...
	public SeasonGHTDetails getGHTVASeasonDetails(String seasonId) {
		...
		try {
			SeasonVADetail seasonVADetail = seasonVADetailsRepository
					.findGHTVADetailsBySeasonId(Integer.valueOf(seasonId));
			if (seasonVADetail != null) {
				seasonGHTDetails = new SeasonGHTDetails();
				seasonGHTDetails.setSeasonId(seasonVADetail.getSeason()
						.getSeasonId());
				seasonGHTDetails.setGhtBaseDetails(seasonServiceImplUtil
						.getVABasicDetail(seasonVADetail));
				seasonGHTDetails.setGhtDates(seasonServiceImplUtil
						.getVADates(seasonVADetail));
				// TODO add notes
			}
		} catch (CcighgoException e) {
			ExceptionUtil.logException(e, LOGGER);
	...
	public GHTSection1Base getGHTVASeasonNameAndStatus(String seasonId) {
		...
		try {
			SeasonVADetail seasonVADetail = seasonVADetailsRepository
					.findGHTVADetailsBySeasonId(Integer.valueOf(seasonId));
			if (seasonVADetail != null) {
				ghtSection1Base = seasonServiceImplUtil
						.getVABasicDetail(seasonVADetail);
			}
		} catch (CcighgoException e) {
			ExceptionUtil.logException(e, LOGGER);
	...
	public GHTSection2Dates getGHTVASeasonDateDetails(String seasonId) {
		...
		try {
			SeasonVADetail seasonVADetail = seasonVADetailsRepository
					.findGHTVADetailsBySeasonId(Integer.valueOf(seasonId));
			if (seasonVADetail != null) {
				ghtSection2Dates = seasonServiceImplUtil
						.getVADates(seasonVADetail);
			}
		} catch (CcighgoException e) {
			ExceptionUtil.logException(e, LOGGER);
	...
	public SeasonGHTDetails updateGHTVASeasonDetails(
		...
		try {
			SeasonVADetail seasonVADetail = seasonVADetailsRepository
					.findGHTVADetailsBySeasonId(Integer
							.valueOf(seasonGHTDetails.getSeasonId()));
			if (seasonVADetail != null) {
				if (seasonGHTDetails.getGhtBaseDetails() != null) {
					seasonServiceImplUtil.updateVABasicDetails(
							seasonGHTDetails.getGhtBaseDetails(),
							seasonVADetail);
				}
				if (seasonGHTDetails.getGhtDates() != null) {
					seasonServiceImplUtil.updateVADates(
							seasonGHTDetails.getGhtDates(), seasonVADetail);
				}
				seasonVADetail = seasonVADetailsRepository
						.saveAndFlush(seasonVADetail);
	...
	public GHTSection1Base updateGHTVASeasonNameAndStatus(
		...
		try {
			SeasonVADetail seasonVADetail = seasonVADetailsRepository
					.findGHTVADetailsBySeasonId(Integer.valueOf(ghtSection1Base
							.getSeasonId()));
			if (seasonVADetail != null) {
				seasonServiceImplUtil.updateVABasicDetails(ghtSection1Base,
						seasonVADetail);
				seasonVADetail = seasonVADetailsRepository
						.saveAndFlush(seasonVADetail);
	...
	public GHTSection2Dates updateGHTVASeasonDateDetails(
		...
		try {
			SeasonVADetail seasonVADetail = seasonVADetailsRepository
					.findGHTVADetailsBySeasonId(Integer
							.valueOf(ghtSection2Dates.getSeasonId()));
			if (seasonVADetail != null) {
				seasonServiceImplUtil.updateVADates(ghtSection2Dates,
						seasonVADetail);
				seasonVADetail = seasonVADetailsRepository
						.saveAndFlush(seasonVADetail);
	...
	public SeasonGHTDetails getGHTWASeasonDetails(String seasonId) {
		SeasonGHTDetails seasonGHTDetails = null;
		try {
			SeasonWADetail seasonWADetail = seasonWADetailsRepository
					.findGHTWADetailsBySeasonId(Integer.valueOf(seasonId));
			if (seasonWADetail != null) {
				seasonGHTDetails = new SeasonGHTDetails();
				seasonGHTDetails.setSeasonId(seasonWADetail.getSeason()
						.getSeasonId());
				seasonGHTDetails.setGhtBaseDetails(seasonServiceImplUtil
						.getWABasicDetail(seasonWADetail));
				seasonGHTDetails.setGhtDates(seasonServiceImplUtil
						.getWADates(seasonWADetail));
				// TODO add notes
			}
		} catch (CcighgoException e) {
			ExceptionUtil.logException(e, LOGGER);
	...
	public SeasonGHTDetails updateGHTWASeasonDetails(
			SeasonGHTDetails seasonGHTDetails) {
		SeasonGHTDetails returnObject = null;
		if (seasonGHTDetails == null) {
			return returnObject;
		...
		try {
			SeasonWADetail seasonWADetail = seasonWADetailsRepository
					.findGHTWADetailsBySeasonId(Integer
							.valueOf(seasonGHTDetails.getSeasonId()));
			if (seasonWADetail != null) {
				if (seasonGHTDetails.getGhtBaseDetails() != null) {
					seasonServiceImplUtil.updateWABasicDetails(
							seasonGHTDetails.getGhtBaseDetails(),
							seasonWADetail);
				}
				if (seasonGHTDetails.getGhtDates() != null) {
					seasonServiceImplUtil.updateWADates(
							seasonGHTDetails.getGhtDates(), seasonWADetail);
				}
				seasonWADetail = seasonWADetailsRepository
						.saveAndFlush(seasonWADetail);
				returnObject = seasonGHTDetails;
			}
		} catch (CcighgoException e) {
			ExceptionUtil.logException(e, LOGGER);
	...
	public GHTSection1Base updateGHTWASeasonNameAndStatus(
			GHTSection1Base ghtSection1Base) {
		GHTSection1Base returnObject = null;
		if (ghtSection1Base == null || ghtSection1Base.getSeasonId() == 0) {
			return returnObject;
		...
		try {
			SeasonWADetail seasonWADetail = seasonWADetailsRepository
					.findGHTWADetailsBySeasonId(Integer.valueOf(ghtSection1Base
							.getSeasonId()));
			if (seasonWADetail != null) {
				seasonServiceImplUtil.updateWABasicDetails(ghtSection1Base,
						seasonWADetail);
				seasonWADetail = seasonWADetailsRepository
						.saveAndFlush(seasonWADetail);
				returnObject = ghtSection1Base;
	...
	public GHTSection2Dates updateGHTWASeasonDateDetails(
			GHTSection2Dates ghtSection2Dates) {
		GHTSection2Dates returnObject = null;
		if (ghtSection2Dates == null || ghtSection2Dates.getSeasonId() == 0) {
			return returnObject;
		...
		try {
			SeasonWADetail seasonWADetail = seasonWADetailsRepository
					.findGHTWADetailsBySeasonId(Integer
							.valueOf(ghtSection2Dates.getSeasonId()));
			if (seasonWADetail != null) {
				seasonServiceImplUtil.updateWADates(ghtSection2Dates,
						seasonWADetail);
				seasonWADetail = seasonWADetailsRepository
						.saveAndFlush(seasonWADetail);
				returnObject = ghtSection2Dates;
	...
	public SeasonGHTDetails getGHTHSAbroad(String seasonId) {
		try {
			SeasonHSADetail seasonHSADetail = seasonHSADetailsRepository
					.findGHTHSBySeasonId(Integer.parseInt(seasonId));
	...
	public SeasonGHTDetails getGHTLanguageSchool(String seasonId) {
		try {
			SeasonLSDetail seasonLSDetail = seasonLSDetailsRepository
					.findGHTLSBySeasonId(Integer.parseInt(seasonId));
	...
	public SeasonGHTDetails updateGHTLanguageSchool(
		...
		try {
			return seasonServiceImplUtil
					.updateGHTLanguageSchool(seasonGHTDetails);
		} catch (CcighgoException e) {
			ExceptionUtil.logException(e, LOGGER);
		}
		return null;
	...
	public SeasonGHTDetails getGHTTeachAbroad(String seasonId) {
		try {
			SeasonTADetail seasonTADetail = seasonTADetailsRepository
					.findGHTTABySeasonId(Integer.parseInt(seasonId));
	...
	public GHTSection1Base updateGHTHSSection1BaseAbroad(
		...
		try {
			return seasonServiceImplUtil
					.updateGHTHSSection1BaseAbroad(ghtSection1Base);
		} catch (CcighgoException e) {
			ExceptionUtil.logException(e, LOGGER);
		}
		return null;
	...
	public GHTSection2Dates updateGHTHSSection2DatesAbroad(
		...
		try {
			return seasonServiceImplUtil
					.updateGHTHSSection2DatesAbroad(ghtSection2Dates);
		} catch (CcighgoException e) {
			ExceptionUtil.logException(e, LOGGER);
		}
		return null;
	...
	public GHTSection1Base updateGHTLanguageSchoolSection1(
		...
		try {
			return seasonServiceImplUtil
					.updateGHTLanguageSchoolSection1(ghtSection1Base);
		} catch (CcighgoException e) {
			ExceptionUtil.logException(e, LOGGER);
		}
		return null;
	...
	public GHTSection2Dates getGHTLanguageSchoolSection2Dates(String seasonId) {
		try {
			return seasonServiceImplUtil
					.getGHTLanguageSchoolSection2Dates(seasonId);
		} catch (CcighgoException e) {
			ExceptionUtil.logException(e, LOGGER);
		}
		return null;
	...
	public GHTSection2Dates updateGHTLanguageSchoolSection2Dates(
		...
		try {
			return seasonServiceImplUtil
					.updateGHTLanguageSchoolSection2Dates(ghtSection2Dates);
		} catch (CcighgoException e) {
			ExceptionUtil.logException(e, LOGGER);
		}
		return null;
	...
	public GHTSection1Base updateGHTTeachAbroadSection1(
		...
		try {
			return seasonServiceImplUtil
					.updateGHTTeachAbroadSection1(ghtSection1Base);
		} catch (CcighgoException e) {
			ExceptionUtil.logException(e, LOGGER);
		}
		return null;
	...
	public GHTSection2Dates getGHTTeachAbroadSection2Dates(String seasonId) {
		try {
			return seasonServiceImplUtil
					.getGHTTeachAbroadSection2Dates(seasonId);
		} catch (CcighgoException e) {
			ExceptionUtil.logException(e, LOGGER);
		}
		return null;
	...
	public GHTSection2Dates updateGHTTeachAbroadSection2Dates(
		...
		try {
			return seasonServiceImplUtil
					.updateGHTTeachAbroadSection2Dates(ghtSection2Dates);
		} catch (CcighgoException e) {
			ExceptionUtil.logException(e, LOGGER);
		}
		return null;
	...
	public WPCAPBasicDetails updateWPCAPBasicDetails(
		...
		try {
			return seasonServiceImplUtil
					.updateWPCAPBasicDetails(wpcapBasicDetails);
		} catch (CcighgoException e) {
			ExceptionUtil.logException(e, LOGGER);
		}
		return null;
	...
	public WPCAPInternshipDetails updateWPCAPInternshipDetails(
		...
		try {
			return seasonServiceImplUtil
					.updateWPCAPInternshipDetails(wpcapInternshipDetails);
		} catch (CcighgoException e) {
			ExceptionUtil.logException(e, LOGGER);
		}
		return null;
	...
	public WPCAPTraineeDetails updateWPCAPTraineeDetails(
		...
		try {
			return seasonServiceImplUtil
					.updateWPCAPTraineeDetails(wpcapTraineeDetails);
		} catch (CcighgoException e) {
			ExceptionUtil.logException(e, LOGGER);
		}
		return null;
