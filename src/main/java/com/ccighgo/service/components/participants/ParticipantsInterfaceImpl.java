...
public class ParticipantsInterfaceImpl implements ParticipantsInterface {
   ...
   @Autowired ParticipantStatusRepository participantStatusRepository;
   ...
   public ParticipantsActiveList getActiveParticipantsList(String partnerId) {
      ...
      try {
         ...
         if (participants != null) {
            ...
            participantsActiveList.setStatus(
   ...
   public ParticipantsLeadList getLeadParticipantsList(String partnerId) {
      ...
      try {
         ...
         participantsLeadList.setStatus(
               componentUtils.getStatus(CCIConstants.SUCCESS, CCIConstants.TYPE_INFO, ErrorCode.DEFAULT_CODE.getValue(), messageUtil.getMessage(CCIConstants.SERVICE_SUCCESS)));
   ...
   public NewManualParticipant addNewParticipant(NewManualParticipant newManualParticipant) {
      try {
            ...
            for (AddNewManualParticipant p : newManualParticipant.getDetails()) {
               ...
               try {
                  ...
                  if (season != null && partner != null) {
                     PartnerSeason ps = partnerSeasonsRepository.findPartnerSeasonBySeasonIdProgramIdPartnerGoId(season.getSeasonId(), p.getDepartmentId(),
                           partner.getGoIdSequence().getGoId());
                     if (ps != null) {
         ...
         newManualParticipant.setStatus(
               componentUtils.getStatus(CCIConstants.SUCCESS, CCIConstants.TYPE_INFO, ErrorCode.DEFAULT_CODE.getValue(), messageUtil.getMessage(CCIConstants.SERVICE_SUCCESS)));
      } catch (Exception e) {
         newManualParticipant.setStatus(
               componentUtils.getStatus(CCIConstants.FAILURE, CCIConstants.TYPE_ERROR, ErrorCode.DEFAULT_CODE.getValue(), messageUtil.getMessage(CCIConstants.SERVICE_FAILURE)));
   ...
   public ProgramOptionsForParticipants getAllAvailableProgramOptions(int partnerId, int seasonId, int departmentProgramId) {
      ...
      try {
         ...
         programOptionsForParticipants.setStatus(
               componentUtils.getStatus(CCIConstants.SUCCESS, CCIConstants.TYPE_INFO, ErrorCode.DEFAULT_CODE.getValue(), messageUtil.getMessage(CCIConstants.SERVICE_SUCCESS)));
      } catch (Exception e) {
         programOptionsForParticipants.setStatus(
               componentUtils.getStatus(CCIConstants.FAILURE, CCIConstants.TYPE_ERROR, ErrorCode.DEFAULT_CODE.getValue(), messageUtil.getMessage(CCIConstants.SERVICE_FAILURE)));
            ...
            for (Participant participant : participants) {
               ...
               if (participant.getParticipantStatus() != null) {
                  ...
                  if (participant.getParticipantStatus().getIsPlacementStatus() == CCIConstants.ACTIVE) {
                     details.setParticipantPlacementStatus(participant.getParticipantStatus().getParticipantStatusName());
                     details.setParticipantPlacementStatusId(participant.getParticipantStatus().getParticipantStatusId());
                  }
