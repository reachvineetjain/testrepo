...
public class SevisLogUtils {
	...
	public boolean isProcessSuccess() {
		 ...
		 * business rules validation (although all other records are
		 * successfully loaded into SEVIS)
		 */
	...
	/**
	 * Records which failed business rule validation; consequently, these
	 * records were not loaded into SEVIS.
	 * 
	 * @return
	 */
