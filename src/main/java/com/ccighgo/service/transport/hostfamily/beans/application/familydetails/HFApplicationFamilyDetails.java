...
/**
 * <p>
 * Java class for HFApplicationFamilyDetails complex type.
 * 
 * <p>
...
@XmlType(name = "HFApplicationFamilyDetails", propOrder = { "loginId", "seasonId", "programId", "hostFamilyId", "singleHost", "photo", "adults", "contactInfo", "physicalAddress",
      "mailingAddress", "hostFamilySeasonId", "airports", "children", "pets", "isTheirChildrenUnder18LivesAtHome" })
public class HFApplicationFamilyDetails extends Response {
   ...
   @XmlElement(required = true) protected Photo photo;
   @XmlElement(required = true) protected List<HFAdultDetails> adults;
   @XmlElement(required = true) protected HFContactInfo contactInfo;
   @XmlElement(required = true) protected HFPhysicalAddress physicalAddress;
   @XmlElement(required = true) protected HFMailingAddress mailingAddress;
   protected int hostFamilySeasonId;
   @XmlElement(required = true) protected List<HFAirport> airports;
   @XmlElement(required = true) protected List<HFChildren> children;
   @XmlElement(required = true) protected List<HFPets> pets;
    ...
    * 
    * @return possible object is {@link Photo }
    * 
    */
    ...
    * 
    * @return possible object is {@link HFContactInfo }
    * 
    */
    ...
    * 
    * @param value
    *           allowed object is {@link HFContactInfo }
    * 
    */
    ...
    * 
    * @return possible object is {@link HFPhysicalAddress }
    * 
    */
    ...
    * 
    * @param value
    *           allowed object is {@link HFPhysicalAddress }
    * 
    */
    ...
    * 
    * @return possible object is {@link HFMailingAddress }
    * 
    */
    ...
    * 
    * @param value
    *           allowed object is {@link HFMailingAddress }
    * 
    */
    ...
    * 
    * <p>
    * Objects of the following type(s) are allowed in the list {@link HFAirport }
    * 
    * 
    */
    ...
    * 
    * <p>
    * Objects of the following type(s) are allowed in the list {@link HFPets }
    * 
    * 
    */
