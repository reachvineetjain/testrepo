 ...
 *         &lt;element name="j1hsDocuments" type="{http://www.ccighgo.com/j1hs}J1HSDocuments" maxOccurs="unbounded"/>
 *         &lt;element name="j1hsNotes" type="{http://www.ccighgo.com/j1hs}J1HSNotes" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class SeasonHspJ1HSDetails {
    ...
    @XmlElement(name = "j1hsDocuments", required = true)
    protected List<J1HSDocuments> j1HsDocuments;
    @XmlElement(name = "j1hsNotes", required = true)
