 ...
 *         &lt;element name="cciContact" type="{http://www.ccighgo.com/partnerihp}PartnerIHPCCIContact" maxOccurs="unbounded"/>
    ...
    extends Response
{
    ...
    @XmlElement(required = true)
    protected List<PartnerIHPCCIContact> cciContact;
    @XmlElement(required = true)
     ...
     * 
     */
    public List<PartnerIHPCCIContact> getCciContact() {
        if (cciContact == null) {
            cciContact = new ArrayList<PartnerIHPCCIContact>();
        }
