 ...
 *         &lt;element name="partnerQuickStatTypes" type="{http://www.ccighgo.com/partnerj1hs}PartnerJ1HSQuickStatType" maxOccurs="unbounded"/>
    ...
    extends Response
{
    ...
    @XmlElement(required = true)
    protected List<PartnerJ1HSQuickStatType> partnerQuickStatTypes;
    @XmlElement(required = true)
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PartnerJ1HSQuickStatType }
     * 
     * 
     */
    public List<PartnerJ1HSQuickStatType> getPartnerQuickStatTypes() {
        if (partnerQuickStatTypes == null) {
            partnerQuickStatTypes = new ArrayList<PartnerJ1HSQuickStatType>();
        }
