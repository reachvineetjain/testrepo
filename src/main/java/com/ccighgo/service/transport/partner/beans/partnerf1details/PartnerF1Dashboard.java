 ...
 *         &lt;element name="cciContact" type="{http://www.ccighgo.com/partnerf1}PartnerF1CCIContact" maxOccurs="unbounded"/>
    ...
    extends Response
{
    ...
    @XmlElement(required = true)
    protected List<PartnerF1CCIContact> cciContact;
    @XmlElement(required = true)
     ...
     * 
     */
    public List<PartnerF1CCIContact> getCciContact() {
        if (cciContact == null) {
            cciContact = new ArrayList<PartnerF1CCIContact>();
        }
