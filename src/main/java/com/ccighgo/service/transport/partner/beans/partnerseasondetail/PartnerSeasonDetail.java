 ...
 *           &lt;element name="announcements" type="{http://www.ccighgo.com/partnerseasondetail}PartnerSeasonAnnouncements" maxOccurs="unbounded" minOccurs="0"/>
    ...
    extends Response
{
    ...
    protected List<PartnerSeasonAnnouncements> announcements;
    @XmlElement(required = true)
     ...
     * 
     */
    public List<PartnerSeasonAnnouncements> getAnnouncements() {
        if (announcements == null) {
            announcements = new ArrayList<PartnerSeasonAnnouncements>();
        }
