...
/**
 * <p>Java class for PartnerCAPDashboard complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PartnerCAPDashboard">
 *   &lt;complexContent>
 ...
 *         &lt;element name="partnerAnnouncements" type="{http://www.ccighgo.com/partnercap}PartnerCAPAnnouncement" maxOccurs="unbounded"/>
 *         &lt;element name="cciContact" type="{http://www.ccighgo.com/partnercap}PartnerCAPCCIContact" maxOccurs="unbounded"/>
 *         &lt;element name="partnerWorkQueueTypes" type="{http://www.ccighgo.com/partnercap}PartnerCAPWorkQueueType" maxOccurs="unbounded"/>
 *         &lt;element name="partnerQuickLinks" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded"/>
 *         &lt;element name="partnerQuickStatTypes" type="{http://www.ccighgo.com/partnercap}PartnerCAPQuickStatType" maxOccurs="unbounded"/>
 *         &lt;element name="partnerCAPPrograms" type="{http://www.ccighgo.com/partnercap}PartnerCAPProgram" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "PartnerCAPDashboard", propOrder = {
    "partnerGoId",
    "partnerLogo",
    "partnerCompany",
...
public class PartnerCAPDashboard
    extends Response
{
    ...
    @XmlElement(required = true)
    protected List<PartnerCAPAnnouncement> partnerAnnouncements;
    @XmlElement(required = true)
    protected List<PartnerCAPCCIContact> cciContact;
    @XmlElement(required = true)
    protected List<PartnerCAPWorkQueueType> partnerWorkQueueTypes;
    @XmlElement(required = true)
    protected List<String> partnerQuickLinks;
    @XmlElement(required = true)
    protected List<PartnerCAPQuickStatType> partnerQuickStatTypes;
    @XmlElement(required = true)
    protected List<PartnerCAPProgram> partnerCAPPrograms;
     ...
     * {@link PartnerCAPAnnouncement }
     * 
     * 
     */
    public List<PartnerCAPAnnouncement> getPartnerAnnouncements() {
        if (partnerAnnouncements == null) {
            partnerAnnouncements = new ArrayList<PartnerCAPAnnouncement>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PartnerCAPCCIContact }
     * 
     * 
     */
    public List<PartnerCAPCCIContact> getCciContact() {
        if (cciContact == null) {
            cciContact = new ArrayList<PartnerCAPCCIContact>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PartnerCAPWorkQueueType }
     * 
     * 
     */
    public List<PartnerCAPWorkQueueType> getPartnerWorkQueueTypes() {
        if (partnerWorkQueueTypes == null) {
            partnerWorkQueueTypes = new ArrayList<PartnerCAPWorkQueueType>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PartnerCAPQuickStatType }
     * 
     * 
     */
    public List<PartnerCAPQuickStatType> getPartnerQuickStatTypes() {
        if (partnerQuickStatTypes == null) {
            partnerQuickStatTypes = new ArrayList<PartnerCAPQuickStatType>();
        }
        return this.partnerQuickStatTypes;
    }

    /**
     * Gets the value of the partnerCAPPrograms property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the partnerCAPPrograms property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPartnerCAPPrograms().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PartnerCAPProgram }
     * 
     * 
     */
    public List<PartnerCAPProgram> getPartnerCAPPrograms() {
        if (partnerCAPPrograms == null) {
            partnerCAPPrograms = new ArrayList<PartnerCAPProgram>();
        }
        return this.partnerCAPPrograms;
    }
