...
/**
 * <p>Java class for CreateSEVISBatch complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CreateSEVISBatch">
 *   &lt;complexContent>
...
@XmlType(name = "CreateSEVISBatch", propOrder = {
    "batchType",
    "userId",
    "seasonId",
    "partnerGoId",
    ...
    extends Response
{
    ...
    @XmlElement(required = true)
    protected List<CreateSEVISBatch.Participant> participant;
     ...
     * {@link CreateSEVISBatch.Participant }
     * 
     * 
     */
    public List<CreateSEVISBatch.Participant> getParticipant() {
        if (participant == null) {
            participant = new ArrayList<CreateSEVISBatch.Participant>();
        }
