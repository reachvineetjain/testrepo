 ...
 *         &lt;element name="departmentFunctions" type="{http://www.ccighgo.com/user}UserDepartmentFunction" maxOccurs="unbounded" minOccurs="0"/>
...
public class User {
    ...
    protected List<UserDepartmentFunction> departmentFunctions;
    ...
    /**
     * Gets the value of the departmentFunctions property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the departmentFunctions property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDepartmentFunctions().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link UserDepartmentFunction }
     * 
     * 
     */
    public List<UserDepartmentFunction> getDepartmentFunctions() {
        if (departmentFunctions == null) {
            departmentFunctions = new ArrayList<UserDepartmentFunction>();
        }
