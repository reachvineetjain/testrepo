...
import com.ccighgo.service.transport.integration.thirdparty.beans.agentViewForPartnerInquiryData.PartnerRecruitmentAgentScreeningDocuments;
...
@XmlSeeAlso({
    PartnerRecruitmentAgent.class,
    PartnerRecruitmentAgentScreeningDocuments.class
})
