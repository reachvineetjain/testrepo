...
import com.ccighgo.service.transport.fieldstaff.beans.fieldstaffapplication.FieldStaffPendingApplication;
...
@XmlSeeAlso({
    FieldStaffPendingApplication.class,
    FieldStaffapplication.class
})
