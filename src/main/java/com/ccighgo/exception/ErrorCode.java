...
public enum ErrorCode {
  ...
  //partner admin seasons
	  ...
	  UPDATE_TOPIC_TAG(8000253), CREATE_TOPIC(8000254), NO_CHANGE_HAPPEN(8000255), MARK_NOTE_AS_READ(8000256), GET_ALL_PARTNER_STATUS(8000257),DOCUMENT_NOT_FOUND(8000258), REMOVE_PARTNER_OFFICE(8000259);
