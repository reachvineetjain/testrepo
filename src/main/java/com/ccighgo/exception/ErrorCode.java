...
public enum ErrorCode {
  ...
  //partner admin seasons
     ...
     CREATE_PARTNER_DOCUMENT(800068), REMOVING_PARTNER_DOCUMENT(800069), CREATE_PARTNER_OFFICE(800070), 
     GET_PARTNER_OFFICE(800071), CREATE_FIELD_STAFF_NOTE(800072), VIEW_FIELD_STAFF_NOTE(800073), UPDATE_FIELD_STAFF_NOTE(800074), DELETE_FIELD_STAFF_NOTE(800075), VIEW_GENERIC_DOCUMENT(800075),
	 FETCH_SALUTATION(8000252), 
	  UPDATE_TOPIC_TAG(8000253), CREATE_TOPIC(8000254), NO_CHANGE_HAPPEN(8000255), MARK_NOTE_AS_READ(8000256), 
	  GET_ALL_PARTNER_STATUS(8000257),DOCUMENT_NOT_FOUND(8000258), 
	  REMOVE_PARTNER_OFFICE(8000259), CHANGE_PARTNER_SEASON(8000260), 
