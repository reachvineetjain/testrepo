      ...
      //Sub-partner
		...
		ERROR_GET_SUB_PARTNER_DETAILS(800002),
		 ...
		 WOEKQUEUE_SUBMITTED_APPLICATIONS(800011),
		  NO_WOEKQUEUE_AGENT_DETAIL(800012), NO_WOEKQUEUE_TYPE(800013), NO_WOEKQUEUE_CATEGORY(800014), CANT_UPDATE_FOLLOW_UP_DATE(800015), FOLLOW_UP_DATE_UPDATED(800015)
		;
