...
public class EncryptionService {
   ...
   /*
    * A key with 16 bytes. This means we are using AES128. To make it AES 192 increase the key bytes to 24 For AES 256
    * the bytes of the key should be 32
    */
    ...
    * @param key
    *           - The key to be used for HMAC hashing
    * @return - The encrypted bytes
    * @throws UnsupportedEncodingException
    * @throws InvalidKeyException
    * @throws NoSuchAlgorithmException
    */
   public byte[] computeSignature(String baseString, String key) throws UnsupportedEncodingException, InvalidKeyException, NoSuchAlgorithmException {
   ...
   /**
    * Encrypts the given password using HMAC-SHA256 encryption and subsequently base64 encodes the encrypted bytes and
    ...
    * 
    * @param identifier
    *           - The identifier to encrypt
    * @return - The encrypted string
    * @throws SecurityException
    */
   public String aesEncryptAndBase64Encode(String identifier) throws SecurityException {
      try {
         Key key = generateKey();
    ...
    * 
    */
   public String aesDecryptAndBase64Decode(String encryptedString) throws SecurityException {
      try {
         Key key = generateKey();
    ...
    * @throws SecurityException
    */
   public String maskEncryptedCreditCardNumber(String encryptedCreditCardNumber) throws SecurityException {
