...
public class PartnerSeasonNotesTest {
   ...
   *//**
    * Tools : http://www.freeformatter.com/json-formatter.html#ad-output to put
    * json on only one line Use notepad to replace " to \"
    *//*
   // @Test
   ...
   public void testCreateTopic() {
      String json = executeService_Post(
            "{\"Topic\":{\"loginId\":\"18\",\"partnerSeasonNoteTopicName\":\"mido\",\"partnerSeasonId\":95,\"competitorInfo\":\"true\",\"embassy_VisaInfo\":\"true\",\"f1\":\"true\",\"ght\":\"true\",\"intern\":\"true\",\"isPublic\":\"true\",\"j1\":\"true\",\"meeting_visit\":\"true\",\"seasonInfo\":\"true\",\"stInbound\":\"true\",\"trainee\":\"true\",\"w_t\":\"false\"}}",
            CREATE_PARTNER_SEASON_NOTE_TOPIC);
      Assert.assertFalse(json.contains("\"statusCode\":\"Failure\""));
      LOGGER.info("Result : " + json);
   }
