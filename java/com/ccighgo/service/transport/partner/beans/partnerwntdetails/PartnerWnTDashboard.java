...
/**
 * <p>Java class for PartnerWnTDashboard complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PartnerWnTDashboard">
 *   &lt;complexContent>
 ...
 *         &lt;element name="partnerAnnouncements" type="{http://www.ccighgo.com/partnerwnt}PartnerWnTAnnouncement" maxOccurs="unbounded"/>
 *         &lt;element name="cciContact" type="{http://www.ccighgo.com/partnerwnt}PartnerWnTCCIContact" maxOccurs="unbounded"/>
 *         &lt;element name="partnerWorkQueueTypes" type="{http://www.ccighgo.com/partnerwnt}PartnerWnTWorkQueueType" maxOccurs="unbounded"/>
 *         &lt;element name="partnerQuickLinks" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded"/>
 *         &lt;element name="partnerQuickStatTypes" type="{http://www.ccighgo.com/partnerwnt}PartnerWnTQuickStatType" maxOccurs="unbounded"/>
 *         &lt;element name="partnerWnTPrograms" type="{http://www.ccighgo.com/partnerwnt}PartnerWnTProgram" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "PartnerWnTDashboard", propOrder = {
    "partnerGoId",
    "partnerLogo",
    "partnerCompany",
...
public class PartnerWnTDashboard
    extends Response
{
    ...
    @XmlElement(required = true)
    protected List<PartnerWnTAnnouncement> partnerAnnouncements;
    @XmlElement(required = true)
    protected List<PartnerWnTCCIContact> cciContact;
    @XmlElement(required = true)
    protected List<PartnerWnTWorkQueueType> partnerWorkQueueTypes;
    @XmlElement(required = true)
    protected List<String> partnerQuickLinks;
    @XmlElement(required = true)
    protected List<PartnerWnTQuickStatType> partnerQuickStatTypes;
    @XmlElement(required = true)
    protected List<PartnerWnTProgram> partnerWnTPrograms;
     ...
     * {@link PartnerWnTAnnouncement }
     * 
     * 
     */
    public List<PartnerWnTAnnouncement> getPartnerAnnouncements() {
        if (partnerAnnouncements == null) {
            partnerAnnouncements = new ArrayList<PartnerWnTAnnouncement>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PartnerWnTCCIContact }
     * 
     * 
     */
    public List<PartnerWnTCCIContact> getCciContact() {
        if (cciContact == null) {
            cciContact = new ArrayList<PartnerWnTCCIContact>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PartnerWnTWorkQueueType }
     * 
     * 
     */
    public List<PartnerWnTWorkQueueType> getPartnerWorkQueueTypes() {
        if (partnerWorkQueueTypes == null) {
            partnerWorkQueueTypes = new ArrayList<PartnerWnTWorkQueueType>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PartnerWnTQuickStatType }
     * 
     * 
     */
    public List<PartnerWnTQuickStatType> getPartnerQuickStatTypes() {
        if (partnerQuickStatTypes == null) {
            partnerQuickStatTypes = new ArrayList<PartnerWnTQuickStatType>();
        }
        return this.partnerQuickStatTypes;
    }

    /**
     * Gets the value of the partnerWnTPrograms property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the partnerWnTPrograms property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPartnerWnTPrograms().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PartnerWnTProgram }
     * 
     * 
     */
    public List<PartnerWnTProgram> getPartnerWnTPrograms() {
        if (partnerWnTPrograms == null) {
            partnerWnTPrograms = new ArrayList<PartnerWnTProgram>();
        }
        return this.partnerWnTPrograms;
    }
