 ...
 *         &lt;element name="partnerAnnouncements" type="{http://www.ccighgo.com/partnerdetails}PartnerAnnouncements" maxOccurs="unbounded"/>
 *         &lt;element name="partnerProgramAccess" type="{http://www.ccighgo.com/partnerdetails}PartnerProgramAccess" maxOccurs="unbounded"/>
    ...
    extends Response
{
    ...
    @XmlElement(required = true)
    protected List<PartnerAnnouncements> partnerAnnouncements;
    @XmlElement(required = true)
    protected List<PartnerProgramAccess> partnerProgramAccess;
    @XmlElement(required = true)
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PartnerAnnouncements }
     * 
     * 
     */
    public List<PartnerAnnouncements> getPartnerAnnouncements() {
        if (partnerAnnouncements == null) {
            partnerAnnouncements = new ArrayList<PartnerAnnouncements>();
        }
        return this.partnerAnnouncements;
    }

    /**
     * Gets the value of the partnerProgramAccess property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the partnerProgramAccess property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPartnerProgramAccess().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PartnerProgramAccess }
     * 
     * 
     */
    public List<PartnerProgramAccess> getPartnerProgramAccess() {
        if (partnerProgramAccess == null) {
            partnerProgramAccess = new ArrayList<PartnerProgramAccess>();
        }
        return this.partnerProgramAccess;
    }
