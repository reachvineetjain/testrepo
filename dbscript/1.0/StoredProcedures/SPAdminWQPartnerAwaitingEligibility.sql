...
DROP PROCEDURE IF EXISTS `SPAdminWQPartnerAwaitingEligibility`$$

CREATE DEFINER=`madhavi`@`%` PROCEDURE `SPAdminWQPartnerAwaitingEligibility`(IN typeId INT(3), IN categoryId INT(3), IN cciStaffUserId INT, roletype VARCHAR(45))
BEGIN
