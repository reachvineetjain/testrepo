...
DROP PROCEDURE IF EXISTS `SPAdminWQPartnerAplicationWithdrawn`$$

CREATE DEFINER=`madhavi`@`%` PROCEDURE `SPAdminWQPartnerAplicationWithdrawn`(IN typeId INT(3), IN categoryId INT(3), IN cciStaffUserId INT, roletype VARCHAR(45))
BEGIN
