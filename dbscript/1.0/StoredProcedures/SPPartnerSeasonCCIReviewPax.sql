...
DROP PROCEDURE IF EXISTS `SPPartnerSeasonCCIReviewPax`$$

CREATE DEFINER=`phanipothula`@`%` PROCEDURE `SPPartnerSeasonCCIReviewPax`( IN partnerId INT, IN seasonId INT, IN depPgmId INT, depPgmOptionId INT)
BEGIN
