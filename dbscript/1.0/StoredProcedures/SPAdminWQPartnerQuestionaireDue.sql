...
DROP PROCEDURE IF EXISTS `SPAdminWQPartnerQuestionaireDue`$$

CREATE DEFINER=`madhavi`@`%` PROCEDURE `SPAdminWQPartnerQuestionaireDue`(IN typeId INT(3), IN categoryId INT(3), IN cciStaffUserId INT, roletype VARCHAR(45))
BEGIN
